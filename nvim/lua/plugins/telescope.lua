return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>sk", builtin.keymaps, { desc = "[S]earch keymaps" })
		vim.keymap.set("n", "<leader>sf", builtin.find_files, { desc = "[S]earch files" })
		vim.keymap.set("n", "<leader>ss", builtin.builtin, { desc = "[S]earch select Telescope" })
		vim.keymap.set("n", "<leader>sM", builtin.man_pages, { desc = "[S]earch man pages" })
		vim.keymap.set("n", "<leader>sm", builtin.marks, { desc = "[S]earch marks" })
		vim.keymap.set("n", "<leader>sw", builtin.grep_string, { desc = "[S]earch current [W]ord" })
		vim.keymap.set("n", "<leader>sg", builtin.live_grep, { desc = "[S]earch by grep" })
		...
		vim.keymap.set("n", "<leader>uC", builtin.colorscheme, { desc = "[S]witch colorscheme" })
